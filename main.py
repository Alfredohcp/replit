...
# food="soup"
# number=11
# print( "Once upon a time, there was a" [age] 'old coder named' [name]"."[name]
# "liked to hum the song" [song]
...
# The first name of a person alfredo
# The last name of a person garcia
# The email address of a person agarcia590_at_cps_edu
# The percentage of marks obtained by a student percent100
# A variable to store the number of items in a shopping cart items=
...
# print(type(num1))
# print(type(num2))
# python knows alot of number types
# implicity without you directly
# telling it (explicit)
# num3=3.14
# print(num3)
# print(type(num3))
...
# print(type(moms_age))
# siblings_age=int(input("how old are your siblings?"))
